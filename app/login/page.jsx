...
const page = () => {
  return (
    <div className="main w-screen h-screen flex box-border font-dns bg-[#0B1437] ">
        <div className="input w-1/2 h-screen content-center">
            ...
            <div className="form mt-[72px]">
              <form className='flex flex-col justify-between h-[316px]'>
                <div className='flex flex-col gap-3'>
                <label className='text-sm font-medium'>Email*</label>
                <input className='bg-transparent border-slate-500 border-[1.5px] rounded-lg py-[5px] pl-[24px] text-sm text-[#A3AED0]' type="text" placeholder='mail@gmail.com'/>
                <label className='text-sm font-medium'>Password*</label>
                <input className='bg-transparent border-slate-500 border-[1.5px] rounded-lg py-[5px] pl-[24px] text-sm text-[#A3AED0]' type='text' placeholder='Min. 8 characters'/>
                </div>
